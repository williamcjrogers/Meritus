...
const ARTICLE_CONTENT: Record<string, ArticleData> = {
  ...
  "adjudication-building-liability-orders": {
    ...
    blocks: [
      ...
      { kind: "para", text: "Section 130 of the Building Safety Act 2022 allows the High Court to order that a \"relevant liability\" of one body corporate is also the liability, or the joint and several liability, of specified associated bodies corporate, where it considers it just and equitable to do so.⁴ Crest sought two distinct orders, and obtained both." },
      { kind: "para", text: "The first was an anticipatory order: that any liability ACL may be found to owe under section 1 of the Defective Premises Act 1972, or as a result of a building safety risk, is also the joint and several liability of each of the seven associates. The court granted it, before trial, on the footing that liability at trial was close to inevitable.⁵ The second was an order making the same seven companies jointly and severally liable for the £14.9m already decided in the adjudication. The court granted that too.⁶" },
      { kind: "para", text: "The distinction matters commercially. The anticipatory order attaches to an outcome that does not yet exist. The adjudication order attaches to a sum that was payable within days. It is the second that changes how adjudications will be run." },
    ...
    references: [
      { id: "1", text: "Crest Nicholson Regeneration Ltd & Ors v Ardmore Construction Ltd (in Administration) & Ors [2026] EWHC 789 (TCC), Constable J, 1 April 2026, at [7] to [13] (the development, the contract, the alleged defects and the November 2023 fire risk appraisal of ACL's own expert).", url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2026/789" },
      { id: "2", text: "[2026] EWHC 789 (TCC) at [14] to [17]: dis-instruction of solicitors and experts in March 2025; notice of adjudication dated 29 May 2025; decision of 29 August 2025 finding breach of section 1(1)(a) of the Defective Premises Act 1972 and awarding approximately £14,928,320.40." },
      { id: "3", text: "[2026] EWHC 789 (TCC) at [18] to [21] and [124]: ACL entered administration on 28 August 2025; the court accepted for the purposes of the application that the timing was coincidental and made no finding that the administration was cynical, but found the decision was driven wholly or in significant part by exposure to post-Grenfell cladding claims." },
      { id: "4", text: "Building Safety Act 2022, sections 130 and 131 (building liability orders; meaning of \"associated\"), and section 130(3) and (6) (\"relevant liability\"; \"building safety risk\").", url: "https://www.legislation.gov.uk/ukpga/2022/30/section/130" },
      { id: "5", text: "[2026] EWHC 789 (TCC) at [125] (anticipatory building liability order granted), with the reasoning at [62] to [124]." },
      { id: "6", text: "[2026] EWHC 789 (TCC) at [214] (adjudication building liability order granted: the seven associates jointly and severally liable for the sums owed under the adjudicator's decision)." },
      { id: "7", text: "[2026] EWHC 789 (TCC) at [135] to [140]: the interim status of a decision does not prevent it creating a liability; the associates' restitutionary counterclaim and the just and equitable test as the safety valve; and the alternative holding that failure to comply with the decision is itself a liability incurred as a result of a building safety risk. Aspect Contracts (Asbestos) Ltd v Higgins Construction plc [2015] UKSC 38 at [24] applied by analogy." },
      { id: "8", text: "[2026] EWHC 789 (TCC) at [143] to [162], endorsing and adopting BDW Trading Ltd v Ardmore Construction Ltd [2024] EWHC 3235 (TCC) (Joanna Smith J); Fiona Trust & Holding Corp v Privalov [2007] UKHL 40; Bresco Electrical Services Ltd (in liquidation) v Michael J Lonsdale (Electrical) Ltd [2020] UKSC 25 at [40]. Permission to appeal BDW was granted by Coulson LJ on 11 February 2025 but the appeal was not pursued following ACL's administration ([147]).", url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2024/3235" },
      { id: "9", text: "[2026] EWHC 789 (TCC) at [61]: the just and equitable assessment is a broad test, necessarily fact specific, discretionary, and to be exercised having regard to the purpose of the Act and all relevant factors; the court declined to set out an exhaustive list of factors. The narrower \"special purpose vehicle\" characterisation of the statutory purpose was accepted in oral argument to be an overstatement ([58]). Findings at [66] to [73]." },
      { id: "10", text: "[2026] EWHC 789 (TCC) at [201] to [203]: analysis of the group's accounts and forecast model, and the holding, following Triathlon and Click St Andrews, that it will be an unusual case in which the source or extent of a respondent's assets or liabilities carries much weight." },
      { id: "11", text: "[2026] EWHC 789 (TCC) at [206] to [208] (inequality of arms in the adjudication), and at [68] to [70] (no positive case on breach; the associates' long engagement with the claim; pre-action protocol letters)." },
      { id: "12", text: "Crest Nicholson Regeneration Ltd & Ors v Ardmore Construction Ltd (in Administration) & Ors [2026] EWHC 1069 (TCC), Constable J, 8 May 2026: permission to appeal refused on all five grounds and leapfrog certification refused ([3] to [26]); no stay of execution and no extended time to pay, with payment within 14 days ([41] to [43]); interest at 5 per cent from 5 September 2025 ([44] to [48]); costs to Crest in full ([49]).", url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2026/1069" },
      { id: "13", text: "Court of Appeal permission to appeal, with expedition, and the administration of five Ardmore group trading businesses: Construction Enquirer, 11 June 2026. Company voluntary arrangement proposals by seven group companies: Construction Enquirer, 12 August 2026. Trade press reporting, not judicial findings.", url: "https://www.constructionenquirer.com/2026/06/11/ardmore-construction-group-collapses-into-administration/" },
    ],
  },
};
