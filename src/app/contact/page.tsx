            ...
            <FadeIn className="lg:col-span-2" delay={0.2}>
              <div className="lg:sticky lg:top-28">
                ...
                <div className="mt-16 pt-8 border-t border-green/8">
                  ...
                  <p className="text-[13px] text-slate/70 leading-relaxed">Meritus Via is a partnership of industry-recognised experts. Full partner biographies and representative matter histories are available via secure access.</p>
