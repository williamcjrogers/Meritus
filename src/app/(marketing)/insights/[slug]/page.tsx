...
const ARTICLE_CONTENT: Record<string, ArticleData> = {
  "delay-analysis-adjudications": {
    ...
    blocks: [
      ...
      { kind: "heading", num: "01", text: "The statutory clock", id: "s1" },
      {
        ...
        detail:
          "The statutory window under the Construction Act. The Referral typically follows within seven days of the Notice; the Response often has as few as fourteen.",
      },
      {
        kind: "para",
      ...
      },
      {
        ...
        point:
          "Cited here for the TCC's robust approach to enforcing adjudicators' decisions. The compressed timetable in which an analysis is produced will not shield it from technical scrutiny.",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2024/2188",
      },
      {
        kind: "heading",
        num: "02",
        text: "Why traditional methods do not compress",
        id: "s2",
      },
      {
        kind: "para",
      ...
      },
      {
        kind: "heading",
        num: "03",
        text: "Concurrency makes it harder",
        id: "s3",
      },
      {
        kind: "para",
      ...
      },
      {
        ...
        court: "Technology & Construction Court",
        point:
          "The leading modern authority on prospective versus retrospective delay analysis, demanding a level of forensic detail that traditional sequential methodologies struggle to deliver within adjudication timescales.⁶",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2012/1773",
      },
      {
        kind: "pull",
        text: "The methodology must be adapted to the forum, not the other way around.",
      },
      {
        kind: "heading",
        num: "04",
        text: "Restructuring the analysis",
        id: "s4",
      },
      {
        kind: "para",
      ...
      {
        kind: "pull",
        text: "The twenty-eight-day clock does not pause for methodological perfectionism.",
      },
    ],
    references: [
      {
        id: "1",
        text: "Housing Grants, Construction and Regeneration Act 1996, s.108 (as amended by the Local Democracy, Economic Development and Construction Act 2009, Part 8).",
        url: "https://www.legislation.gov.uk/ukpga/1996/53/section/108",
      },
      {
        id: "2",
        text: "CNO Plant Hire Ltd v Caldwell Construction Ltd [2024] EWHC 2188 (TCC).",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2024/2188",
      },
      {
        id: "3",
        text: "Society of Construction Law, Delay and Disruption Protocol, 2nd Edition (February 2017).",
        url: "https://www.scl.org.uk/resources/delay-disruption-protocol",
      },
      {
        id: "4",
        text: "Henry Boot Construction (UK) Ltd v Malmaison Hotel (Manchester) Ltd [1999] 70 Con LR 32.",
      },
      {
        id: "5",
        text: "Royal Brompton Hospital NHS Trust v Hammond (No. 7) [2001] 76 Con LR 148.",
      },
      {
        id: "6",
        text: "Walter Lilly & Company Ltd v Mackay [2012] EWHC 1773 (TCC).",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2012/1773",
      },
    ],
  },
  ...
  "building-safety-act-remediation": {
    ...
    blocks: [
      ...
      },
      {
        kind: "heading",
        num: "02",
        text: "Causation is the real battleground",
        id: "s2",
      },
      {
        kind: "para",
      ...
      },
      {
        kind: "heading",
        num: "03",
        text: "Anatomy of a remediation dispute",
        id: "s3",
      },
      {
        kind: "para",
      ...
      },
      {
        kind: "heading",
        num: "04",
        text: "Old discipline, new framework",
        id: "s4",
      },
      {
        kind: "para",
    ...
    references: [
      {
        id: "1",
        text: "Building Safety Act 2022 (c. 30).",
        url: "https://www.legislation.gov.uk/ukpga/2022/30/contents",
      },
      {
        id: "2",
        text: "Building Safety Act 2022, ss.116-125 and Schedule 8 (Remediation of certain defects).",
        url: "https://www.legislation.gov.uk/ukpga/2022/30/section/124",
      },
      {
        id: "3",
        text: "The Building Regulations 2010 (SI 2010/2214).",
        url: "https://www.legislation.gov.uk/uksi/2010/2214/contents",
      },
      {
        id: "4",
        text: "Defective Premises Act 1972, s.1 (as amended by Building Safety Act 2022, s.135, extending the limitation period to 30 years retrospectively).",
        url: "https://www.legislation.gov.uk/ukpga/1972/35/section/1",
      },
      {
        id: "5",
        text: "BS 8414-1:2015+A1:2017, Fire performance of external cladding systems. Test method for non-loadbearing external cladding systems applied to the masonry face of a building.",
        url: "https://knowledge.bsigroup.com/products/fire-performance-of-external-cladding-systems-test-method-for-non-loadbearing-external-cladding-systems-applied-to-the-masonry-face-of-a-building",
      },
      {
        id: "6",
        text: "HM Government, Approved Document B: Fire Safety, Volume 1: Dwellings (2019 edition incorporating amendments).",
        url: "https://www.gov.uk/government/publications/fire-safety-approved-document-b",
      },
      {
        id: "7",
        text: "Building Safety Act 2022, Schedule 8, paras 2-4 (Leaseholder protections: qualifying leaseholders of relevant buildings are protected from remediation costs).",
        url: "https://www.legislation.gov.uk/ukpga/2022/30/schedule/8",
      },
    ],
  },
  ...
  "ai-in-construction-disputes": {
    ...
    blocks: [
      ...
      },
      {
        kind: "heading",
        num: "01",
        text: "Processing is not analysis",
        id: "s1",
      },
      {
        kind: "para",
      ...
      },
      {
        kind: "heading",
        num: "02",
        text: "What the technology actually does",
        id: "s2",
      },
      {
        kind: "view",
      ...
      },
      {
        ...
        point:
          "CPR 35.1 restricts expert evidence to that 'reasonably required to resolve the proceedings', a principle that demands focus and selectivity, not the indiscriminate volume that AI tools can generate.⁴",
    ...
    references: [
      {
        id: "1",
        text: "Civil Procedure Rules, Part 35.3, Experts: overriding duty to the court.",
        url: "https://www.justice.gov.uk/courts/procedure-rules/civil/rules/part35",
      },
      {
        id: "2",
        text: "Practice Direction 35, Experts and Assessors, para 3.2.",
        url: "https://www.justice.gov.uk/courts/procedure-rules/civil/rules/part35/pd_part35",
      },
      {
        id: "3",
        text: "The Academy of Experts, Guidance for Expert Witnesses on the Use of Artificial Intelligence (January 2026).",
        url: "https://academyofexperts.org/practising-as-expert/expert-witness-guidance/guidance-for-expert-witnesses-on-the-use-of-artificial-intelligence-ai/",
      },
      {
        id: "4",
        text: "Lord Justice Birss, 'Expert Witnesses: Vital Participants in Civil Justice', Speech to the Expert Witness Institute Annual Conference (20 June 2025).",
        url: "https://www.judiciary.uk/speech-by-lord-justice-birss-expert-witnesses-vital-participants-in-civil-justice/",
      },
      {
        id: "5",
        text: "Solicitors Regulation Authority, Code of Conduct for Solicitors, RELs and RFLs (as updated).",
  ...
  "proving-disruption-claims": {
    ...
    blocks: [
      ...
      },
      {
        kind: "heading",
        num: "01",
        text: "Lost productivity, not lost time",
        id: "s1",
      },
      {
        kind: "para",
      ...
      },
      {
        kind: "heading",
        num: "02",
        text: "The measured mile and its limits",
        id: "s2",
      },
      {
        kind: "para",
      ...
      {
        kind: "pull",
        text: "A disruption claim is won or lost in the project records, long before an expert touches it.",
      },
      ...
      },
      {
        kind: "heading",
        num: "04",
        text: "Building the claim bottom-up",
        id: "s4",
      },
      {
        kind: "list",
    ...
    references: [
      {
        id: "1",
        text: "Society of Construction Law, Delay and Disruption Protocol, 2nd Edition (February 2017), Part B guidance on disruption.",
        url: "https://www.scl.org.uk/resources/delay-disruption-protocol",
      },
      {
        id: "2",
        text: "Whittall Builders Co Ltd v Chester-le-Street District Council (1985) 40 BLR 82.",
      },
      {
        id: "3",
        text: "AACE International, Recommended Practice No. 25R-03, Estimating Lost Labor Productivity in Construction Claims (2004).",
        url: "https://web.aacei.org/docs/default-source/toc/toc_25r-03.pdf",
      },
      {
        id: "4",
        text: "Van Oord UK Ltd v Allseas UK Ltd [2015] EWHC 3074 (TCC).",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2015/3074",
      },
      {
        id: "5",
        text: "Walter Lilly & Company Ltd v Mackay [2012] EWHC 1773 (TCC).",
  ...
  "smash-and-grab-true-value": {
    ...
    blocks: [
      ...
      {
        kind: "pull",
        text: "Pay now, argue later is not a slogan. It is the sequencing rule the courts actually enforce.",
      },
      {
        kind: "para",
      ...
      },
      {
        kind: "heading",
        num: "03",
        text: "Losses that were never about valuation",
        id: "s3",
      },
      {
        kind: "para",
    ...
    references: [
      {
        id: "1",
        text: "Housing Grants, Construction and Regeneration Act 1996, s.111, as substituted by the Local Democracy, Economic Development and Construction Act 2009, s.144.",
        url: "https://www.legislation.gov.uk/ukpga/2009/20/section/144",
      },
      {
        id: "2",
        text: "Housing Grants, Construction and Regeneration Act 1996, ss.110A and 110B (payment notices and payee's notices in default).",
        url: "https://www.legislation.gov.uk/ukpga/1996/53/section/110A",
      },
      {
        id: "3",
        text: "S&T (UK) Ltd v Grove Developments Ltd [2018] EWCA Civ 2448.",
        url: "https://caselaw.nationalarchives.gov.uk/ewca/civ/2018/2448",
      },
      {
        id: "4",
        text: "M Davenport Builders Ltd v Greer & Anor [2019] EWHC 318 (TCC).",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2019/318",
      },
      {
        id: "5",
        text: "Bexheat Ltd v Essex Services Group Ltd [2022] EWHC 936 (TCC).",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2022/936",
      },
      {
        id: "6",
        text: "Henry Construction Projects Ltd v Alu-Fix (UK) Ltd [2023] EWHC 2010 (TCC).",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2023/2010",
      },
    ],
  },
  ...
  "expert-witness-independence": {
    ...
    blocks: [
      ...
      },
      {
        kind: "heading",
        num: "02",
        text: "From criticism to exclusion",
        id: "s2",
      },
      {
        kind: "para",
      ...
      {
        kind: "pull",
        text: "An expert who argues the case stops assisting the tribunal. And tribunals have stopped pretending not to notice.",
      },
      {
        kind: "heading",
        num: "03",
        text: "How credibility actually dies",
        id: "s3",
      },
      {
        kind: "para",
      ...
      },
      {
        kind: "heading",
        num: "04",
        text: "Traceability as protection",
        id: "s4",
      },
      {
        kind: "para",
    ...
    references: [
      {
        id: "1",
        text: "National Justice Compania Naviera SA v Prudential Assurance Co Ltd (The Ikarian Reefer) [1993] 2 Lloyd's Rep 68.",
        url: "https://www.uniset.ca/other/cs2/19932LLR68.html",
      },
      {
        id: "2",
        text: "Civil Procedure Rules, Part 35 and Practice Direction 35.",
        url: "https://www.justice.gov.uk/courts/procedure-rules/civil/rules/part35",
      },
      {
        id: "3",
        text: "Jones v Kaney [2011] UKSC 13.",
        url: "https://caselaw.nationalarchives.gov.uk/uksc/2011/13",
      },
      {
        id: "4",
        text: "Dana UK Axle Ltd v Freudenberg FST GmbH [2021] EWHC 1413 (TCC).",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2021/1413",
      },
      {
        id: "5",
        text: "Andrews & Ors v Kronospan Ltd [2022] EWHC 479 (QB).",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/qb/2022/479",
      },
      {
        id: "6",
        text: "Imperial Chemical Industries Ltd v Merit Merrell Technology Ltd [2018] EWHC 1577 (TCC).",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2018/1577",
      },
      {
        id: "7",
        text: "Beattie Passive Norse Ltd v Canham Consulting Ltd [2021] EWHC 1116 (TCC).",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2021/1116",
      },
    ],
  },
  ...
  "concurrent-delay-entitlement": {
    ...
    blocks: [
      ...
      {
        kind: "para",
        text: "The result is not generosity to contractors. It reflects the structure of the bargain: the employer accepts the risk of the events it has designated as relevant events, and the contractor cannot be held to a completion date that the employer's own acts helped to make unachievable. The Society of Construction Law Delay and Disruption Protocol, 2nd edition (February 2017), adopts the same position at Core Principle 10: concurrent contractor delay should not reduce the extension of time due.⁶",
      },
      {
        kind: "authority",
        name: "Walter Lilly & Company Ltd v Mackay",
        citation: "[2012] EWHC 1773 (TCC)",
        court: "Technology and Construction Court, Akenhead J",
        point:
      ...
      {
        kind: "para",
        text: "City Inn Ltd v Shepherd Construction Ltd [2010] CSIH 68 took a different road.³ The Inner House of the Court of Session held, by a majority, that where two causes of delay are concurrent and neither can be identified as dominant, the decision-maker may apportion the delay between them in a fair and reasonable way, treating the exercise as one of judgment rather than strict causation.",
      },
      {
        kind: "para",
        text: "City Inn is regularly cited in English adjudications and just as regularly overvalued. It is a Scottish decision, persuasive authority at most, and Akenhead J expressly declined to follow it in Walter Lilly. Apportionment of an extension of time forms no part of English law. A tribunal invited to split a concurrent period sixty-forty on a contract governed by English law is being invited into an exercise the authorities do not sanction, and a responding party should say so plainly.",
      },
      {
        kind: "authority",
        name: "City Inn Ltd v Shepherd Construction Ltd",
        citation: "[2010] CSIH 68",
        court: "Inner House, Court of Session",
        point:
      ...
      },
      {
        ...
        url: "https://caselaw.nationalarchives.gov.uk/ewca/civ/2018/1744",
      },
      {
        kind: "para",
        text: "Wherever the contractual line falls, the dispute is decided on the records. Concurrency arguments collapse or succeed on the quality of the as-built evidence and the causal analysis built on it, and the party that can demonstrate what was actually driving completion, week by week, usually prevails.",
      },
      {
        kind: "list",
        title: "What the records must show",
        items: [
    ...
    references: [
      {
        id: "1",
        text: "Henry Boot Construction (UK) Ltd v Malmaison Hotel (Manchester) Ltd (1999) 70 Con LR 32 (TCC, Dyson J).",
      },
      {
        id: "2",
        text: "Walter Lilly & Company Ltd v Mackay [2012] EWHC 1773 (TCC), Akenhead J at [370].",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2012/1773",
      },
      {
        id: "3",
        text: "City Inn Ltd v Shepherd Construction Ltd [2010] CSIH 68 (Inner House, Court of Session).",
        url: "https://www.bailii.org/scot/cases/ScotCS/2010/2010CSIH68.html",
      },
      {
        id: "4",
        text: "De Beers UK Ltd v Atos Origin IT Services UK Ltd [2010] EWHC 3276 (TCC), Edwards-Stuart J.",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2010/3276",
      },
      {
        id: "5",
        text: "North Midland Building Ltd v Cyden Homes Ltd [2018] EWCA Civ 1744, Coulson LJ.",
        url: "https://caselaw.nationalarchives.gov.uk/ewca/civ/2018/1744",
      },
      {
        id: "6",
        text: "Society of Construction Law, Delay and Disruption Protocol, 2nd edition (February 2017), Core Principles 10 and 14.",
        url: "https://www.scl.org.uk/resources/delay-disruption-protocol",
      },
    ],
  },
  "gateway-delay-risk-allocation": {
    ...
    references: [
      {
        id: "1",
        text: "Building Safety Regulator, building control gateway 2 performance update, twelve-week rolling period to 1 August 2026 (approval rates, median determination times, live caseload and gateway 3 figures).",
        url: "https://buildingsafety.campaign.gov.uk/building-safety-regulator-making-buildings-safer/the-building-control-authority/building-control-approval-application-data/",
      },
      {
        id: "2",
        text: "Building Safety Regulator building control approval application data, January to March 2026 and April to June 2026 (GOV.UK).",
        url: "https://www.gov.uk/government/collections/building-safety-regulator-building-control-approval-application-data",
      },
      {
        id: "3",
        text: "Clin v Walter Lilly & Co Ltd [2021] EWCA Civ 136 (Court of Appeal, 8 February 2021).",
        url: "https://caselaw.nationalarchives.gov.uk/ewca/civ/2021/136",
      },
      {
        id: "4",
        text: "JCT Design and Build Contract 2016, clauses 2.26.12, 2.26.13 and 4.21.4; JCT Design and Build Contract 2024, clauses 2.26.7, 2.26.8, 4.21.6 and 4.21.7, and JCT commentary on their application through the Contract Particulars.",
        url: "https://corporate.jctltd.co.uk/the-jct-design-and-build-contract-2024-edition-a-year-on/",
      },
      {
        id: "5",
        text: "NEC4 Engineering and Construction Contract, clause 60.1(19) (prevention).",
      },
    ],
  },
  "building-safety-levy-completion": {
    ...
    references: [
      {
        id: "1",
        text: 'The Building Safety Levy (England) Regulations 2025, SI 2025/1236, in force 1 October 2026 (England only); regulation 6 ("major residential development": at least 10 dwellings or at least 30 bedspaces in purpose-built student accommodation) and regulation 15 (charge to the levy).',
        url: "https://www.legislation.gov.uk/uksi/2025/1236/made",
      },
      {
        id: "2",
        text: "SI 2025/1236, regulations 20 and 21 with Schedule 3: a previously developed site is one where at least 75 per cent of the land to which the relevant planning permission relates was previously developed immediately before the relevant date.",
        url: "https://www.legislation.gov.uk/uksi/2025/1236/regulation/21/made",
      },
      {
        id: "3",
        text: "SI 2025/1236, regulations 37 to 40 (determination of levy liability, levy liability notice, notice of no charge) and regulation 24 (levy due date); Ministry of Housing, Communities and Local Government, Building Safety Levy: Guidance.",
        url: "https://www.gov.uk/guidance/building-safety-levy-guidance",
      },
      {
        id: "4",
        text: "SI 2025/1236, regulations 58, 60 and 62 (withholding a completion certificate; rejecting a final certificate; rejecting completion certificate applications), and regulations 71 to 73 (request for a review, carrying out a review, appeal against a review decision).",
        url: "https://www.legislation.gov.uk/uksi/2025/1236/regulation/58/made",
      },
      {
        id: "5",
        text: "Draft Building Safety Levy (Amendment) (England) Regulations 2026, laid before Parliament under section 120A(7) of the Building Act 1984 and expressed to come into force on 1 October 2026. Status as at 17 August 2026: draft.",
        url: "https://www.legislation.gov.uk/ukdsi/2026/9780348285123",
      },
      {
        id: "6",
        text: "SI 2025/1236, regulations 22 and 23 with Schedule 4 (liability of the named client, and the identification of the named client for full plans applications, initial notices and higher-risk building applications).",
        url: "https://www.legislation.gov.uk/uksi/2025/1236/regulation/23/made",
      },
      {
        id: "7",
        text: "JCT Design and Build Contract 2016, clauses 2.26.6, 2.26.12 and 4.21.5.",
      },
      {
        id: "8",
        text: "JCT Design and Build Contract 2024, clauses 2.26.8 and 4.21.7, and JCT commentary on their application through the Contract Particulars; NEC4 Engineering and Construction Contract, secondary Option X2 (changes in law).",
        url: "https://corporate.jctltd.co.uk/the-jct-design-and-build-contract-2024-edition-a-year-on/",
      },
      {
        id: "9",
        text: "Building Safety Regulator, building control gateway 2 performance update, twelve-week rolling period to 1 August 2026.",
        url: "https://buildingsafety.campaign.gov.uk/building-safety-regulator-making-buildings-safer/the-building-control-authority/building-control-approval-application-data/",
      },
      {
        id: "10",
        text: "Building Act 1984, section 32 (lapse of building control approval where work is not commenced within 3 years), and the Building Regulations 2010, regulation 46A (meaning of commencement for the purposes of section 32(6)).",
        url: "https://www.legislation.gov.uk/ukpga/1984/55/section/32",
      },
    ],
  },
  "adjudication-building-liability-orders": {
    takeaways: [
      "An adjudicator's decision can found a building liability order. The temporary character of the decision does not stop it creating a liability capable of transmission to associated companies under section 130 of the Building Safety Act 2022.",
      "The order can be made before any finding of liability at trial. The court granted an anticipatory building liability order covering whatever liability is eventually established, and a second order for the £14.9m already decided in adjudication.",
      "What decided it was the record. Engagement history, the absence of a positive case on breach, and unexplained gaps in the group's own financial disclosure did more work than any argument about the statutory purpose.",
    ],
    blocks: [
      {
        kind: "lead",
        text: "For thirty years the standard reassurance about adjudication has been that it is rough justice between two contracting parties, temporarily binding, and reversible at trial. Crest Nicholson v Ardmore leaves the first two halves of that sentence intact and removes the comfort. A decision of an adjudicator, reached in a process the responding company barely defended, was used to impose joint and several liability for £14.9m on seven companies that never signed the contract. It was made before trial, without a stay, payable in fourteen days. The law in the judgment is new and will be tested on appeal. The reasoning that produced the result is not new at all: it is an assessment of what six years of correspondence, expert engagement and corporate restructuring actually showed.",
      },

      { kind: "heading", num: "01", text: "The sequence", id: "s1" },
      {
        kind: "para",
        text: 'Admiralty Quarter in Portsmouth is nineteen residential apartment buildings, constructed between 2007 and March 2009 under a JCT 1998 design and build contract dated 13 December 2005 between Crest Nicholson Regeneration Ltd and Ardmore Construction Ltd ("ACL").¹ After Grenfell, investigation of the external walls disclosed combustible insulation, missing and defectively installed cavity barriers and missing fire resistant sheathing, together with internal compartmentation and firestopping defects. ACL engaged with the allegations for years: it attended intrusive inspections from October 2018, instructed its own fire, architectural and building experts, and took part in expert meetings through 2021. Its own fire engineering expert reported in November 2023 that the overall risk across the external walls was high.¹',
      },
      {
        kind: "para",
...

      {
        ...
        value: "1",
        suffix: "day",
        label: "Administration to decision",
        detail:
      ...
      { kind: "heading", num: "02", text: "Two orders, not one", id: "s2" },
      {
        kind: "para",
        text: 'Section 130 of the Building Safety Act 2022 allows the High Court to order that a "relevant liability" of one body corporate is also the liability, or the joint and several liability, of specified associated bodies corporate, where it considers it just and equitable to do so.⁴ Crest sought two distinct orders, and obtained both.',
      },
      {
        kind: "para",
        text: "The first was an anticipatory order: that any liability ACL may be found to owe under section 1 of the Defective Premises Act 1972, or as a result of a building safety risk, is also the joint and several liability of each of the seven associates. The court granted it, before trial, on the footing that liability at trial was close to inevitable.⁵ The second was an order making the same seven companies jointly and severally liable for the £14.9m already decided in the adjudication. The court granted that too.⁶",
      },
      {
        kind: "para",
        text: "The distinction matters commercially. The anticipatory order attaches to an outcome that does not yet exist. The adjudication order attaches to a sum that was payable within days. It is the second that changes how adjudications will be run.",
      },

      {
        kind: "authority",
        name: "Crest Nicholson Regeneration Ltd & Ors v Ardmore Construction Ltd (in Administration) & Ors",
        citation: "[2026] EWHC 789 (TCC)",
        court: "Constable J, 1 April 2026",
        point:
        ...
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2026/789",
      },

      {
        kind: "heading",
        num: "03",
        text: "Why an adjudicator's decision counts",
        id: "s3",
      },
      {
        kind: "para",
...

      {
        ...
        paragraphs: [
          ...
          "Meritus Via builds that evidence base at machine speed: correspondence, inspection and expert records, contract documents and corporate filings ingested, mapped and cross-referenced within hours of instruction, every conclusion traceable to source and every method disclosable. The analysis of entitlement and the opinion remain where they belong, with senior practitioners, partner-led from first instruction through to testimony. We automate the preparation. Never the judgment.",
        ],
      },
    ],
    references: [
      {
        id: "1",
        text: "Crest Nicholson Regeneration Ltd & Ors v Ardmore Construction Ltd (in Administration) & Ors [2026] EWHC 789 (TCC), Constable J, 1 April 2026, at [7] to [13] (the development, the contract, the alleged defects and the November 2023 fire risk appraisal of ACL's own expert).",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2026/789",
      },
      {
        id: "2",
        text: "[2026] EWHC 789 (TCC) at [14] to [17]: dis-instruction of solicitors and experts in March 2025; notice of adjudication dated 29 May 2025; decision of 29 August 2025 finding breach of section 1(1)(a) of the Defective Premises Act 1972 and awarding approximately £14,928,320.40.",
      },
      {
        id: "3",
        text: "[2026] EWHC 789 (TCC) at [18] to [21] and [124]: ACL entered administration on 28 August 2025; the court accepted for the purposes of the application that the timing was coincidental and made no finding that the administration was cynical, but found the decision was driven wholly or in significant part by exposure to post-Grenfell cladding claims.",
      },
      {
        id: "4",
        text: 'Building Safety Act 2022, sections 130 and 131 (building liability orders; meaning of "associated"), and section 130(3) and (6) ("relevant liability"; "building safety risk").',
        url: "https://www.legislation.gov.uk/ukpga/2022/30/section/130",
      },
      {
        id: "5",
        text: "[2026] EWHC 789 (TCC) at [125] (anticipatory building liability order granted), with the reasoning at [62] to [124].",
      },
      {
        id: "6",
        text: "[2026] EWHC 789 (TCC) at [214] (adjudication building liability order granted: the seven associates jointly and severally liable for the sums owed under the adjudicator's decision).",
      },
      {
        id: "7",
        text: "[2026] EWHC 789 (TCC) at [135] to [140]: the interim status of a decision does not prevent it creating a liability; the associates' restitutionary counterclaim and the just and equitable test as the safety valve; and the alternative holding that failure to comply with the decision is itself a liability incurred as a result of a building safety risk. Aspect Contracts (Asbestos) Ltd v Higgins Construction plc [2015] UKSC 38 at [24] applied by analogy.",
      },
      {
        id: "8",
        text: "[2026] EWHC 789 (TCC) at [143] to [162], endorsing and adopting BDW Trading Ltd v Ardmore Construction Ltd [2024] EWHC 3235 (TCC) (Joanna Smith J); Fiona Trust & Holding Corp v Privalov [2007] UKHL 40; Bresco Electrical Services Ltd (in liquidation) v Michael J Lonsdale (Electrical) Ltd [2020] UKSC 25 at [40]. Permission to appeal BDW was granted by Coulson LJ on 11 February 2025 but the appeal was not pursued following ACL's administration ([147]).",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2024/3235",
      },
      {
        id: "9",
        text: '[2026] EWHC 789 (TCC) at [61]: the just and equitable assessment is a broad test, necessarily fact specific, discretionary, and to be exercised having regard to the purpose of the Act and all relevant factors; the court declined to set out an exhaustive list of factors. The narrower "special purpose vehicle" characterisation of the statutory purpose was accepted in oral argument to be an overstatement ([58]). Findings at [66] to [73].',
      },
      {
        id: "10",
        text: "[2026] EWHC 789 (TCC) at [201] to [203]: analysis of the group's accounts and forecast model, and the holding, following Triathlon and Click St Andrews, that it will be an unusual case in which the source or extent of a respondent's assets or liabilities carries much weight.",
      },
      {
        id: "11",
        text: "[2026] EWHC 789 (TCC) at [206] to [208] (inequality of arms in the adjudication), and at [68] to [70] (no positive case on breach; the associates' long engagement with the claim; pre-action protocol letters).",
      },
      {
        id: "12",
        text: "Crest Nicholson Regeneration Ltd & Ors v Ardmore Construction Ltd (in Administration) & Ors [2026] EWHC 1069 (TCC), Constable J, 8 May 2026: permission to appeal refused on all five grounds and leapfrog certification refused ([3] to [26]); no stay of execution and no extended time to pay, with payment within 14 days ([41] to [43]); interest at 5 per cent from 5 September 2025 ([44] to [48]); costs to Crest in full ([49]).",
        url: "https://caselaw.nationalarchives.gov.uk/ewhc/tcc/2026/1069",
      },
      {
        id: "13",
        text: "Court of Appeal permission to appeal, with expedition, and the administration of five Ardmore group trading businesses: Construction Enquirer, 11 June 2026. Company voluntary arrangement proposals by seven group companies: Construction Enquirer, 12 August 2026. Trade press reporting, not judicial findings.",
        url: "https://www.constructionenquirer.com/2026/06/11/ardmore-construction-group-collapses-into-administration/",
      },
    ],
  },
};
...
function ArticleBlock({ block }: { block: Block }) {
  switch (block.kind) {
    case "lead":
      return <p className="public-article-lead">{block.text}</p>;
    case "heading":
    ...
    case "authority":
      return (
        <aside className="public-article-authority">
          <p className="public-meta">Authority</p>
          <h3>{block.name}</h3>
          <p className="public-meta">
            {block.citation}, {block.court}
          </p>
          <p>{block.point}</p>
          {block.url && (
    ...
    case "stat":
      return (
        <aside className="public-article-fact">
          <strong>
            {block.value} {block.suffix}
          </strong>
          <div>
            <h3>{block.label}</h3>
            <p>{block.detail}</p>
    ...
    case "view":
      return (
        <aside className="public-article-view">
          <h3>The Meritus view</h3>
...
export default async function InsightArticlePage({
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `${SITE_CONFIG.url}/insights/${slug}`,
    },
  ...
  return (
    <>
      ...
      <header className="public-article-heading public-container">
        <Link href="/insights" className="public-text-link">
          All insights
        </Link>
        <p className="public-page-label">{article.category}</p>
        <h1>{article.title}</h1>
      ...
      <div className="public-container public-article-layout">
        ...
        <article className="public-article-body">
          <section className="public-takeaways">
            <h2>Key takeaways</h2>
            <ul>
          ...
          <div className="public-article-blocks">
            {content.blocks.map((block, i) => (
              <ArticleBlock key={i} block={block} />
            ))}
          </div>
          {content.references.length > 0 && (
            <section className="public-article-references">
              <h2>References</h2>
              <ol>
                {content.references.map((reference) => (
                  <li key={reference.id} value={Number(reference.id)}>
                    {reference.url ? (
                      <a
                        href={reference.url}
                        target="_blank"
          ...
          <p className="public-article-disclaimer">
            The views expressed in this article are those of the author and are
            intended for general information only. They do not constitute legal
            advice and should not be relied upon as such. Specific professional
            advice should be sought in relation to any particular matter.
          </p>
          <Link href="/insights" className="public-text-link">
            Return to insights
          </Link>
      ...
      <CTABand
        ...
        subtext="Tell us how the issue relates to your project."
      />
    </>
  );
}
