      ...
      {SECTORS.map((sector, sectorIdx) => (
        <div key={sector.num}>
          ...
          {sector.subSectors.map((sub, subIdx) => {
            ...
            const globalIdx = sectorIdx * 4 + subIdx;
            const bgClass = globalIdx % 2 === 0 ? "bg-stone" : "bg-parchment";
                    ...
                    <div className={`grid grid-cols-1 gap-12 lg:gap-20 ${isReversed ? "lg:grid-cols-[minmax(400px,500px)_1fr] 2xl:grid-cols-[550px_1fr]" : "lg:grid-cols-[1fr_minmax(400px,500px)] 2xl:grid-cols-[1fr_550px]"}`}>
                      ...
                      <div className={isReversed ? "order-1 lg:order-2" : "order-1 lg:order-1"}>
                        <FadeIn delay={0.1}>
                          ...
                          {/* Landmark Case */}
                          <div className="mb-8 p-5 border border-green/10 bg-green/[0.03] relative">
                            ...
                            <div className="font-mono text-[10px] text-slate/60 tracking-wide mb-2">
