...
export const SERVICES: ServicePage[] = [
  {
    ...
    metaTitle: "Delay Analysis Expert UK | Meritus",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "Quantum Expert Construction UK | Meritus",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "Construction Technical Expert UK | Meritus",
    metaDescription:
  ...
  {
    slug: "adjudication-advisory",
    title: "Adjudication & Dispute Advisory",
    heroStatement:
    ...
    metaTitle: "Adjudication Advisory Services UK | Meritus",
    metaDescription:
