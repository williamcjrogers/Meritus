...
export function Header() {
  ...
  return (
    <>
      ...
      >
        <div className="relative z-10 max-w-[1200px] 2xl:max-w-[1400px] 3xl:max-w-[1600px] mx-auto px-6 lg:px-[6%] xl:px-[8%]">
          <nav className="relative flex items-center justify-between gap-5 xl:gap-6 h-16 lg:h-20" aria-label="Main navigation">
            ...
            <div
              className="hidden lg:flex shrink-0 items-center justify-center gap-4 xl:gap-6"
            ...
            {/* Right Action Links */}
            <div className="hidden lg:flex shrink-0 items-center gap-3 xl:gap-4 whitespace-nowrap">
              <Link
                href="/access"
                className={`text-[12px] font-medium tracking-wide transition-colors duration-300 ${darkChrome ? "text-green/70 hover:text-green" : "text-cream/80 hover:text-cream"}`}
              >
                Client access
              </Link>
