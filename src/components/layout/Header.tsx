    ...
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          scrolled
            ? "bg-stone/95 backdrop-blur-md shadow-[0_1px_2px_rgba(0,0,0,0.06)]"
            : "bg-transparent"
        }`}
      >
            ...
            <div className="hidden lg:flex items-center gap-10">
              ...
              <Link
                ...
                className={`text-[13px] font-medium tracking-wide transition-all duration-200 border-b ${
                  scrolled
                    ? "text-green border-green/20 hover:border-brass hover:text-brass"
                    : "text-cream border-cream/20 hover:border-brass hover:text-brass"
                }`}
              >
              ...
              {[0, 1, 2].map((i) => (
                <span
                  ...
                  className={`block w-5 h-[1.5px] transition-all duration-300 ${
                    scrolled ? "bg-green" : "bg-cream"
                  } ${i === 0 && mobileOpen ? "rotate-45 translate-y-[4.5px]" : ""}
